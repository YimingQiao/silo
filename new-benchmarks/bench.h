...
public:
  bench_loader(unsigned long seed, abstract_db *db) : r(seed), db(db), b(0) {}
...
protected:
  ...
  // #else
  //   inline ALWAYS_INLINE void measure_txn_counters(void *txn, const char
  //   *txn_name) {}
  // #endif
...
public:
  ...
  virtual bool invoke(const std::string &key, const std::string &value) {
