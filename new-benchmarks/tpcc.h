...
private:                                                                                                         \
  std::vector<std::shared_ptr<typename Database::template IndexType<schema<name>>::type>> tbl_##name##_vec;      \
                                                                                                                 \
public:                                                                                                          \
  inline ALWAYS_INLINE typename Database::template IndexType<schema<name>>::type *tbl_##name(unsigned int wid) { \
    INVARIANT(wid >= 1);                                                                                         \
