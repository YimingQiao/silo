...
namespace private_ {
  ...
  struct helper {
    static inline void apply(std::ostream &o, const std::tuple<Types...> &t) {
      ...
      helper<Idx + 1, (Idx + 1) < std::tuple_size<std::tuple<Types...>>::value, Types...>::apply(o, t);
    }
  };
 ...
 */
  ...
  public:
    scoped_timer(const std::string &region, bool enabled = true) : region(region), enabled(enabled) {}
