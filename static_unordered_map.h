 ...
 */
template<typename Key, typename T, size_t StaticSize = SMALL_SIZE_MAP, typename Hash = private_::myhash<Key>>
...
public:
  ...
  ~static_unordered_map() {
    ...
    if (ml) private_::evt_avg_max_unordered_map_chain_length.offer(ml);
#endif
  }
