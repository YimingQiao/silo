 ...
 */
[[maybe_unused]] static void fclose_orDie(FILE *file) {
 ...
 */
[[maybe_unused]] static size_t fread_orDie(void *buffer, size_t sizeToRead, FILE *file) {
 ...
 */
[[maybe_unused]] static size_t fwrite_orDie(const void *buffer, size_t sizeToWrite, FILE *file) {
 ...
 */
[[maybe_unused]] static void *mallocAndLoadFile_orDie(const char *fileName, size_t *bufferSize) {
    size_t const fileSize = fsize_orDie(fileName);
    *bufferSize = fileSize;
 ...
 */
[[maybe_unused]] static void saveFile_orDie(const char *fileName, const void *buff, size_t buffSize) {
