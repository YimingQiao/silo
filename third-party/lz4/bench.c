...
int BMK_benchFile(char **fileNamesTable, int nbFiles, int cLevel) {
  ...
  while (fileIdx < nbFiles) {
    ...
    // Bench
    {
      ...
      for (loopNb = 1; loopNb <= nbIterations; loopNb++) {
        // Compression
        DISPLAY("%1i-%-14.14s : %9i ->\r", loopNb, infilename,
                (int)benchedSize);
        {
          size_t i;
        ...
        while (BMK_GetMilliSpan(milliTime) < TIMELOOP) {
          for (chunkNb = 0; chunkNb < nbChunks; chunkNb++)
            chunkP[chunkNb].compressedSize = compP.compressionFunction(
        ...
        DISPLAY("%1i-%-14.14s : %9i -> %9i (%5.2f%%),%7.1f MB/s\r", loopNb,
        ...
        while (BMK_GetMilliSpan(milliTime) < TIMELOOP) {
          for (chunkNb = 0; chunkNb < nbChunks; chunkNb++)
            // chunkP[chunkNb].origSize =
            // LZ4_decompress_safe(chunkP[chunkNb].compressedBuffer,
            // chunkP[chunkNb].origBuffer, chunkP[chunkNb].compressedSize,
            // chunkSize);
            chunkP[chunkNb].compressedSize = LZ4_decompress_fast(
                chunkP[chunkNb].compressedBuffer, chunkP[chunkNb].origBuffer,
                chunkP[chunkNb].origSize);
          // chunkP[chunkNb].compressedSize =
          // LZ4_decompress_fast_withPrefix64k(chunkP[chunkNb].compressedBuffer,
          // chunkP[chunkNb].origBuffer, chunkP[chunkNb].origSize);
          // chunkP[chunkNb].origSize =
          // LZ4_decompress_safe_withPrefix64k(chunkP[chunkNb].compressedBuffer,
          // chunkP[chunkNb].origBuffer, chunkP[chunkNb].compressedSize,
          // chunkSize); chunkP[chunkNb].origSize =
          // LZ4_decompress_safe_partial(chunkP[chunkNb].compressedBuffer,
          // chunkP[chunkNb].origBuffer, chunkP[chunkNb].compressedSize,
          // chunkSize-5, chunkSize); chunkP[chunkNb].compressedSize =
          // LZ4_uncompress(chunkP[chunkNb].compressedBuffer,
          // chunkP[chunkNb].origBuffer, chunkP[chunkNb].origSize);
          // chunkP[chunkNb].origSize =
          // LZ4_uncompress_unknownOutputSize(chunkP[chunkNb].compressedBuffer,
          // chunkP[chunkNb].origBuffer, chunkP[chunkNb].compressedSize,
          // chunkSize);
          nb_loops++;
        }
  ...
  if (nbFiles > 1)
    DISPLAY("%-16.16s :%10llu ->%10llu (%5.2f%%), %6.1f MB/s , %6.1f MB/s\n",
            "  TOTAL", (long long unsigned int)totals,
            (long long unsigned int)totalz,
            (double)totalz / (double)totals * 100.,
            (double)totals / totalc / 1000., (double)totals / totald / 1000.);
