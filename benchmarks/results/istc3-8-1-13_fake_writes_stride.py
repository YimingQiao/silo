RESULTS = [({'scale_factor': 1, 'db': 'ndb-proto2', 'par_load': False, 'threads': 1, 'bench_opts': '',
            ...
            [(28307.9, 28307.9, 0.0351975, 79.8686, 0.0), (29468.8, 29468.8, 0.0338098, 79.6989, 0.0),
             (28633.6, 28633.6, 0.0348038, 79.6323, 0.0)]), (
               {'scale_factor': 4, 'db': 'ndb-proto2', 'par_load': False, 'threads': 4, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '16G', 'persist': True},
               [(104982.0, 104982.0, 0.0379605, 93.4454, 3.94635), (105986.0, 105986.0, 0.0375971, 91.3793, 4.42884),
                (105113.0, 105113.0, 0.0379221, 92.7033, 4.24529)]), (
               {'scale_factor': 8, 'db': 'ndb-proto2', 'par_load': False, 'threads': 8, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '32G', 'persist': True},
               [(199243.0, 199243.0, 0.0400266, 94.1939, 7.99375), (201042.0, 201042.0, 0.0396748, 94.4927, 8.71124),
                (200883.0, 200883.0, 0.0396838, 97.8034, 8.74218)]), (
               {'scale_factor': 12, 'db': 'ndb-proto2', 'par_load': False, 'threads': 12, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '48G', 'persist': True},
               [(295769.0, 295769.0, 0.0404389, 104.279, 12.0241), (299185.0, 299185.0, 0.0399775, 102.402, 11.5576),
                (297104.0, 297104.0, 0.0402344, 101.553, 13.0691)]), (
               {'scale_factor': 16, 'db': 'ndb-proto2', 'par_load': False, 'threads': 16, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '64G', 'persist': True},
               [(390716.0, 390716.0, 0.0408101, 103.202, 16.7986), (388866.0, 388866.0, 0.0409949, 97.7126, 15.7795),
                (389102.0, 389102.0, 0.0409839, 102.555, 16.0022)]), (
               {'scale_factor': 20, 'db': 'ndb-proto2', 'par_load': False, 'threads': 20, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '80G', 'persist': True},
               [(487630.0, 487630.0, 0.0408567, 100.113, 20.5283), (486838.0, 486838.0, 0.0409294, 101.562, 20.4595),
                (485790.0, 485790.0, 0.0410379, 105.509, 19.7705)]), (
               {'scale_factor': 24, 'db': 'ndb-proto2', 'par_load': False, 'threads': 24, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '96G', 'persist': True},
               [(588835.0, 588835.0, 0.0406064, 99.1126, 23.9914), (586711.0, 586711.0, 0.0407728, 101.417, 23.647),
                (582473.0, 582473.0, 0.0410752, 102.085, 24.7148)]), (
               {'scale_factor': 28, 'db': 'ndb-proto2', 'par_load': False, 'threads': 28, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '112G', 'persist': True},
               [(675848.0, 675848.0, 0.0412852, 101.447, 28.2844), (677514.0, 677514.0, 0.041175, 98.7786, 30.5281),
                (676236.0, 676236.0, 0.0412817, 99.7915, 28.8308)]), (
               {'scale_factor': 32, 'db': 'ndb-proto2', 'par_load': False, 'threads': 32, 'bench_opts': '',
                'log_fake_writes': True, 'retry': False, 'log_nofsync': False, 'name': 'scale_tpcc', 'bench': 'tpcc',
                'numa_memory': '128G', 'persist': True},
               [(723982.0, 723982.0, 0.044027, 236.204, 29.7214), (722847.0, 722847.0, 0.0441212, 307.379, 29.3968),
                (728086.0, 728086.0, 0.0437917, 235.66, 31.3378)]), (
