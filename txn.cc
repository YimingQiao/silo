...
static string proto2_version_str(uint64_t v) {
  ostringstream b;
  b << "[core=" << transaction_proto2_static::CoreId(v) << " | n=" << transaction_proto2_static::NumId(v)
...
event_counter transaction_base::g_evt_read_logical_deleted_node_search("read_logical_deleted_node_search");
event_counter transaction_base::g_evt_read_logical_deleted_node_scan("read_logical_deleted_node_scan");
event_counter transaction_base::g_evt_dbtuple_write_search_failed("dbtuple_write_search_failed");
event_counter transaction_base::g_evt_dbtuple_write_insert_failed("dbtuple_write_insert_failed");
