...
struct generic_serializer {
  ...
  static inline uint8_t *write(uint8_t *buf, const uint8_t *obj) {
    return Serializer::write(buf, *reinterpret_cast<const obj_type *>(obj));
  }

  static inline const uint8_t *read(const uint8_t *buf, uint8_t *obj) {
    return Serializer::read(buf, reinterpret_cast<obj_type *>(obj));
  }

  // returns nullptr on failure
  static inline const uint8_t *failsafe_read(const uint8_t *buf, size_t nbytes, uint8_t *obj) {
    return Serializer::failsafe_read(buf, nbytes, reinterpret_cast<obj_type *>(obj));
  }

  static inline size_t nbytes(const uint8_t *obj) {
    return Serializer::nbytes(reinterpret_cast<const obj_type *>(obj));
  }

  static inline size_t skip(const uint8_t *stream, uint8_t *rawv) { return Serializer::skip(stream, rawv); }

  // returns 0 on failure
  static inline size_t failsafe_skip(const uint8_t *stream, size_t nbytes, uint8_t *rawv) {
    return Serializer::failsafe_skip(stream, nbytes, rawv);
  }

  static inline constexpr size_t max_nbytes() { return Serializer::max_bytes(); }
};
...
struct serializer {
  ...
  static inline const uint8_t *failsafe_read(const uint8_t *buf, size_t nbytes, T *obj) {
    if (unlikely(nbytes < sizeof(T))) return nullptr;
    return read(buf, obj);
  }
  ...
  static inline constexpr size_t max_nbytes() { return sizeof(T); }
};
...
struct serializer<uint32_t, true> {
  ...
  static inline uint8_t *write(uint8_t *buf, uint32_t obj) { return write_uvint32(buf, obj); }

  static inline const uint8_t *read(const uint8_t *buf, uint32_t *obj) { return read_uvint32(buf, obj); }

  static inline const uint8_t *failsafe_read(const uint8_t *buf, size_t nbytes, uint32_t *obj) {
    return failsafe_read_uvint32(buf, nbytes, obj);
  }

  static inline size_t nbytes(const uint32_t *obj) { return size_uvint32(*obj); }

  static inline size_t skip(const uint8_t *stream, uint8_t *rawv) { return skip_uvint32(stream, rawv); }

  static inline size_t failsafe_skip(const uint8_t *stream, size_t nbytes, uint8_t *rawv) {
    return failsafe_skip_uvint32(stream, nbytes, rawv);
  }

  static inline constexpr size_t max_nbytes() { return 5; }
};
...
struct serializer<int32_t, true> {
  ...
  static inline uint8_t *write(uint8_t *buf, int32_t obj) {
    const uint32_t v = encode(obj);
    return serializer<uint32_t, true>::write(buf, v);
  }

  static inline const uint8_t *read(const uint8_t *buf, int32_t *obj) {
    uint32_t v;
  ...
  static inline const uint8_t *failsafe_read(const uint8_t *buf, size_t nbytes, int32_t *obj) {
    uint32_t v;
  ...
  static inline size_t nbytes(const int32_t *obj) {
    const uint32_t v = encode(*obj);
...
private:
  ...
  static inline ALWAYS_INLINE constexpr uint32_t encode(int32_t value) { return (value << 1) ^ (value >> 31); }
